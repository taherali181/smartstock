...
| Operations | Phase 3 order/task foundation: persisted purchase and sales aggregates, decimal lines, named versioned commands, automatic receiving/picking task handoff, live operational queue, RLS, audit and outbox | receipt/inventory coupling, fulfillment execution, returns, reporting and offline scanner execution |
