...
| Operations | Phase 3 order/task foundation with atomic receiving, inventory-backed allocation, and reservation-backed shipment execution: valued inbound/outbound ledger posting, quarantine, tolerances, row-locked reservations, partial/full derived states, receive/pick/putaway work, live queue, RLS, audit and outbox | returns, reporting and offline scanner execution |
