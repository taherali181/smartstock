...
| Operations | Phase 3 order/task foundation plus atomic purchase receiving: persisted purchase and sales aggregates, decimal lines, named versioned commands, accepted/quarantined receipt posting into the balanced valued ledger, partial and tolerance-controlled receiving, automatic receive/pick/putaway task handoff, live operational queue, RLS, audit and outbox | fulfillment execution, returns, reporting and offline scanner execution |
