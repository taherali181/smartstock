...
| Operations | Phase 3 order/task foundation: persisted purchase and sales aggregates, decimal lines, named versioned commands, warehouse task queues, RLS, audit and outbox | receipts, allocation/fulfillment, returns, automatic task generation, reporting and offline scanner execution |
